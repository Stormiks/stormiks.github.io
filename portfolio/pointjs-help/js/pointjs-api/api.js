const API = {
	...
	'BaseObject.shadowColor': {
		type: 'hidden',
	},
	'BaseObject.shadowBlur': {
		type: 'hidden',
	},
	'BaseObject.shadowX': {
		type: 'hidden',
	...
	'pjs.game.newTriangleObject({})': {
		...
		Данный объект наследует.BaseObject() с его методами и все его свойства, тут указаны лишь уникальные для этого объекта ',
	...
	'BackgroundObject.fullW': {
		type: 'hidden',
	},
	'BackgroundObject.fullH': {
		type: 'hidden',
	},
	'BackgroundObject.cnv': {
		type: 'hidden',
	},
	'BackgroundObject.ctx': {
		type: 'hidden',
	},
	'BackgroundObject.loaded': {
	...
	'AnimationObject.toFrameStep': {
		type: 'hidden',
	},
	'AnimationObject.difStep': {
		type: 'hidden',
	},
	'AnimationObject.anim': {
		type: 'hidden',
	},
	'AnimationObject.getFrame': {
	...
	'AnimationObject.drawReverFrames': {
